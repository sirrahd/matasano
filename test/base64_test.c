...
void TestIntToB64String(int * success, int * failure)
{
    ...
    {
        char result[100];
        printResult(FUNCNAME, tests[i], IntToB64String(result, atoi(tests[i][0])), success, failure);
    }
}
...
void TestHexStringToB64String(int * success, int * failure)
{
    ...
    {
        char result[100];
        printResult(FUNCNAME, tests[i], HexStringToB64String(result, tests[i][0]), success, failure);
    }
}
